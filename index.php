...
// Option to update cart with new quantity
...
<div class="header">
  <a href="#default" class="logo">NLB Shoes</a>
...
<div class="products">
   ...
   <h1 class="heading">Available Shoes</h1>
   ...
   ?>
      <form method="post" class="box" action="">
         ...
         <div class="color"><?php echo $fetch_product['color']; ?></div>
         <div class="size"><?php echo $fetch_product['size']; ?></div>
